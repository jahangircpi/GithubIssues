...
List<WholeDataLists> wholeDataListsFromJson(String str) =>
    List<WholeDataLists>.from(
        json.decode(str).map((x) => WholeDataLists.fromJson(x)));

String wholeDataListsToJson(List<WholeDataLists> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class WholeDataLists {
  WholeDataLists({
    this.url,
    this.repositoryUrl,
    this.labelsUrl,
  ...
  factory WholeDataLists.fromJson(Map<String, dynamic> json) => WholeDataLists(
        url: json["url"],
...
enum AuthorAssociation { CONTRIBUTOR, NONE, MEMBER }
